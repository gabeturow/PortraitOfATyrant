...
public class ManualFloatDamper {
	public float Value{ get; set; }
	public float Target{ get; set; }
	public float Speed{ get; set; }
	public float velocity;
	public ManualFloatDamper(float speed) : this(0, speed){}
	public ManualFloatDamper(float init, float speed){
		Value = Target = init;
		this.Speed = speed;
	}
	public void Update(){
...
public class FloatDamper : ValueDamper{
	...
	public System.Action<float> Submit = null;
}

public class Vector3SpringDamper : ValueDamper{
	public Vector3SpringDamper(Vector3 init, float speed) : base(){
	...
	public override void Update(){
		if (Vector3.Distance(Value, Target) > .01f)
			Value = Utilities.SimpleHarmonicMotion(Value, Target, ref velocity, 1/(Speed+.0001f), 1f);
	}
}
...
public class Vector3Damper : ValueDamper{
	...
	public void UpdateDeltaTime(){
		if (Vector3.Distance(Value, Target) > .01f)
			Value = Vector3.SmoothDamp(Value, Target, ref velocity, Speed, Mathf.Infinity, Time.deltaTime);
	}
}
...
public class ColorDamper : ValueDamper{
	...
	public System.Action<Color> Submit = null;
}