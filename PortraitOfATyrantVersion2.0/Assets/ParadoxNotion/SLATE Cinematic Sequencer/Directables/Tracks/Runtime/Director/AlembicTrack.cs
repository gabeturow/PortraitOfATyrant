...
namespace Slate{
	...
	public class AlembicTrack : CutsceneTrack {
		...
		private float abcLinkStartTime{
			get {return alembicStream != null? alembicStream.m_startTime + alembicStream.m_timeOffset : float.NegativeInfinity;}
		}

		private float abcLinkEndTime{
			get {return alembicStream != null? alembicStream.m_endTime + alembicStream.m_timeOffset : float.NegativeInfinity;}
		}
